...
time_between_each_keystroke = float(input("| Time between each keystroke: (0.02) ") or "0.02")
time_between_each_code = float(input("| Time between each code: (0.05) ") or "0.05")
